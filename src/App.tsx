      ...
      <section className="love-letter">
        ...
        <form onSubmit={submit}>
          ...
          <p className="error-message" aria-live="polite">
            {error ? "Not quite, love. Think back to where our story began." : "\u00a0"}
          </p>
          <button className="unlock-button" type="submit">
            Open our calendar <ArrowRight size={18} />
          </button>
        </form>
    ...
    >
      <article className="memory-modal" role="dialog" aria-modal="true" aria-labelledby="memory-title">
        ...
        <div className="modal-copy">
          ...
          <span>
            NYC <Heart size={14} fill="currentColor" /> LA
          </span>
        </div>
      </article>
    </div>
    ...
    <main className="calendar-page">
      ...
      <section className="memory-section">
        <div className="section-heading">
          <div>
            <p className="eyebrow">OUR COUNTDOWN</p>
            <h2>25 days, 25 little pieces of us</h2>
          </div>
          <p>New York time meets Los Angeles time, right here.</p>
        </div>
      ...
      <footer>
        ...
        <p>Made across 2,451 miles, just for you.</p>
      </footer>
