...
const days = [
  ...
  ['2026-08-19', 'Two sides', 'Hotty booby and goofy momo. When did we decide to pick sides. But I think its more like I can be hottie so I just pick the goofy side.'],
